...
function s.filter(c)
	return c:IsSetCard(SET_GRAVEKEEPERS) and c:IsFaceup()
end
function s.atkval(e,c)
	return Duel.GetMatchingGroupCount(s.filter,c:GetControler(),LOCATION_MZONE,LOCATION_MZONE,e:GetHandler())*200
end
