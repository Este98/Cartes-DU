...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Attach 1 other face-up monster to this card as material
	...
	e2:SetCondition(function(e,tp,eg,ep,ev,re,r,rp) return r&REASON_LOST_TARGET==0 and Duel.IsTurnPlayer(e:GetHandlerPlayer() end)
