...
s.listed_names={59851535}
function s.spfilter(c,e,tp)
	return c:IsSetCard(SET_WITCHCRAFTER) and not c:IsCode(59851535) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.thfilter(c)
	return c:IsSetCard(SET_WITCHCRAFTER) and c:IsAbleToHand()
end
