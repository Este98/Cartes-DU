...
function s.initial_effect(c)
	--This card's name becomes "Amazoness Queen" while on the field or in the GY
	...
	c:RegisterEffect(e1)
	--Add 1 "Amazoness" Spell/Trap from your Deck to your hand
...
s.listed_names={15951532,id} --"Amazoness Queen"
