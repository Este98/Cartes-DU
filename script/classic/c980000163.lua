...
function s.thfilter(c)
	return c:IsSetCard(SET_BEETROOPER) and c:IsAbleToHand()
end
...
function s.spfilter(c,e,tp)
	return c:IsFaceup() and c:IsSetCard(SET_BEETROOPER) and c:IsLevelBelow(4) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
