...
function s.flipcon(e,tp,eg,ep,ev,re,r,rp)
    ...
    return aux.CanActivateSkill(tp)
        ...
        and Duel.IsExistingMatchingCard(Card.IsContinuousSpell, tp, LOCATION_SZONE, 0, 1, nil)
end
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
    ...
    local atk=Duel.GetMatchingGroupCount(Card.IsContinuousSpell,tp,LOCATION_SZONE,0,nil)*200
